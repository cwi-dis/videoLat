...
#ifdef WITH_UIKIT
// iOS version has no prepare button, it's handled by the previous view
...
#else
@property(weak) IBOutlet NSButton *bPrepare;    //!< Initialized in the NIB: reference to the run button.
