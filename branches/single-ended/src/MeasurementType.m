...
+ (void)initialize
{
    ...
    [self addType: @"Camera Input Calibrate (based on Screen)" tag: 4 isCalibration: NO requires: cal_OUT];
    [self addType: @"Screen Output Calibrate (based on Camera)" tag: 5 isCalibration: NO requires: cal_IN];
